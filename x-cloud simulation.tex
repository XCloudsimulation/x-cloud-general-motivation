...
\input{case_services.tex}

%------------------------------------------------------------------

\section{Desiard model}
\input{desiard_model.tex}

%------------------------------------------------------------------

\section{Proposed research topics}
\input{research_topics/dc_size.tex}
\input{research_topics/internet_of_things.tex}
\input{research_topics/mobility.tex}
\input{research_topics/nbr_devices.tex}
\input{research_topics/placement.tex}
\input{research_topics/topology.tex}
\input{research_topics/traffic.tex}
\input{research_topics/vm_placement.tex}
%------------------------------------------------------------------
